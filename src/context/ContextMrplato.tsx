  ...
  switch (actionMrplato.type) {
    case ADD_NEW_LINE_TO_LIST:
      ...
      stateMrplato.new_lines_list.forEach((element) => {
        if (
          element.content === actionMrplato.payload.content &&
          element.type === actionMrplato.payload.type
        ) {
          verify = true;
        }
      });
      if (verify) {
        ...
        return {
          ...stateMrplato,
          new_lines_list: [
            ...stateMrplato.new_lines_list,
            actionMrplato.payload,
          ],
        };
      }
    ...
    case CREATE_SESSION_EXERCISE:
      return {
        ...stateMrplato,
        info_exercise: actionMrplato.payload.body.data,
        lines_list: actionMrplato.payload.body.data.new_lines,
      };
